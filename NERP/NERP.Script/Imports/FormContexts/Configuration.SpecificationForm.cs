...
namespace NERP.Configuration
{
    ...
    public partial class SpecificationForm : PrefixedContext
    {
        [InlineConstant] public const string FormKey = "Configuration.Specification";

        public SpecificationForm(string idPrefix) : base(idPrefix) {}
