...
namespace NERP.Configuration
{
    ...
    public partial class PaymentMethodForm : PrefixedContext
    {
        [InlineConstant] public const string FormKey = "Configuration.PaymentMethod";

        public PaymentMethodForm(string idPrefix) : base(idPrefix) {}
        ...
        public IntegerEditor IsPaymentDetailReq { get { return ById<IntegerEditor>("IsPaymentDetailReq"); } }
