...
namespace NERP.Configuration
{
    ...
    public partial class SizeForm : PrefixedContext
    {
        [InlineConstant] public const string FormKey = "Configuration.Size";

        public SizeForm(string idPrefix) : base(idPrefix) {}
