...
namespace NERP.Configuration
{
    ...
    public partial class OrganogramRow
    {
        ...
        [InlineConstant] public const string LocalTextPrefix = "Configuration.Organogram";
        [InlineConstant] public const string LookupKey = "Configuration.Organogram";
    
        public static Lookup<OrganogramRow> Lookup { [InlineCode("Q.getLookup('Configuration.Organogram')")] get { return null; } }
