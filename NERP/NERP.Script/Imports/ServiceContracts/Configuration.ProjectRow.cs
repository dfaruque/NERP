...
namespace NERP.Configuration
{
    ...
    public partial class ProjectRow
    {
        ...
        [InlineConstant] public const string LocalTextPrefix = "Configuration.Project";
        [InlineConstant] public const string LookupKey = "Configuration.Project";
    
        public static Lookup<ProjectRow> Lookup { [InlineCode("Q.getLookup('Configuration.Project')")] get { return null; } }
