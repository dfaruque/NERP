...
namespace NERP.Configuration
{
    ...
    public partial class PaymentMethodRow
    {
        ...
        [InlineConstant] public const string LocalTextPrefix = "Configuration.PaymentMethod";
        ...
        {
            [InlineConstant] public const string IsPaymentDetailReq = "IsPaymentDetailReq";
