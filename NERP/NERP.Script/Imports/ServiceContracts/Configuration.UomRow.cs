...
namespace NERP.Configuration
{
    ...
    public partial class UomRow
    {
        ...
        [InlineConstant] public const string LocalTextPrefix = "Configuration.Uom";
        [InlineConstant] public const string LookupKey = "Configuration.Uom";
    
        public static Lookup<UomRow> Lookup { [InlineCode("Q.getLookup('Configuration.Uom')")] get { return null; } }
    
        public Int32? UomTyepId { get; set; }
        public Decimal? RateToStandard { get; set; }
        ...
        {
            [InlineConstant] public const string UomTyepId = "UomTyepId";
            [InlineConstant] public const string RateToStandard = "RateToStandard";
