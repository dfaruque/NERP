...
namespace NERP.Configuration
{
    ...
    public partial class StyleRow
    {
        ...
        [InlineConstant] public const string LocalTextPrefix = "Configuration.Style";
        [InlineConstant] public const string LookupKey = "Configuration.Style";
    
        public static Lookup<StyleRow> Lookup { [InlineCode("Q.getLookup('Configuration.Style')")] get { return null; } }
