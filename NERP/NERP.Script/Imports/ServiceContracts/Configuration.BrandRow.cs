...
namespace NERP.Configuration
{
    ...
    public partial class BrandRow
    {
        ...
        [InlineConstant] public const string LocalTextPrefix = "Configuration.Brand";
        [InlineConstant] public const string LookupKey = "Configuration.Brand";
    
        public static Lookup<BrandRow> Lookup { [InlineCode("Q.getLookup('Configuration.Brand')")] get { return null; } }
