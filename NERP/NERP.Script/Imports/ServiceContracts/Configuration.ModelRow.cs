...
namespace NERP.Configuration
{
    ...
    public partial class ModelRow
    {
        ...
        [InlineConstant] public const string LocalTextPrefix = "Configuration.Model";
        [InlineConstant] public const string LookupKey = "Configuration.Model";
    
        public static Lookup<ModelRow> Lookup { [InlineCode("Q.getLookup('Configuration.Model')")] get { return null; } }
