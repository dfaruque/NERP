...
namespace NERP.Configuration
{
    ...
    public partial class ColorRow
    {
        ...
        [InlineConstant] public const string LocalTextPrefix = "Configuration.Color";
        [InlineConstant] public const string LookupKey = "Configuration.Color";
    
        public static Lookup<ColorRow> Lookup { [InlineCode("Q.getLookup('Configuration.Color')")] get { return null; } }
        ...
        {
            [InlineConstant] public const string HexValue = "HexValue";
