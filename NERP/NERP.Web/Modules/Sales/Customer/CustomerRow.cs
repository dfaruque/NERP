...
namespace NERP.Sales.Entities
{
    ...
    [ConnectionKey("NERPDB"), DisplayName("Customer"), InstanceName("Customer"), TwoLevelCached]
    [ReadPermission("Administration")]
    [ModifyPermission("Administration")]
    public sealed class CustomerRow : BaseRow
    {
        ...
        public class RowFields : BaseRow.BaseRowFields
        {
            ...
            public RowFields()
                : base("[Sal].[Customer]")
            {
                LocalTextPrefix = "Sales.Customer";
            }
        }
    }
}